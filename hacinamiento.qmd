...
Uno de los objetivos de la materia es, como se detalla en el programa, aportar herramientas que permitan la producción de un dato primario de calidad. Sin embargo, también es cierto que una de las maneras de agregarle valor a cualquier dato primario es su pertinente combinación con algún otro dato secundario ya existente. Por otro lado, existen situaciones en donde el uso exclusivo de fuentes secundarios es la mejor opción. Ejemplos típicos pueden considerarse:
...
A continuación, a modo de ejemplo de como complementar un dato primario con otro secundario, se hará un análisis que utilice tanto datos de la encuesta (como fuente primaria) como algunos datos del censo de 2010 (como fuente secundaria).
