...
```{r}
#| label: etiquetado_valores

# Se eliminan los signos interrogativos de las preguntas que salen del google forms
...
Este tipo de metainformación suele ser útil para que el programa detecte que tipo de gráfico es apropiado o que tipo de cálculo realizar. De todos modos los programas vienen cada vez con mejores heurísticas para adivinar, sin previa indicación de que tipo de dato se trata.
